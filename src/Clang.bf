...
static class Clang
{
	// had to make this manually :(
	// libclang has an awful lot of functions '^'
	...
	[CLink, LinkName("clang_getCursorSpelling")]
	public static extern CXString GetCursorSpelling(CXCursor cursor);

	[CLink, LinkName("clang_getCString"), return: MangleConst]
	public static extern c_char* GetCString(CXString str);

	[CLink, LinkName("clang_disposeString")]
	public static extern void DisposeString(CXString str);

	//index
	public typealias CXIndex = void*;

	[CLink, LinkName("clang_createIndex")]
	public static extern CXIndex CreateIndex();

	[CLink, LinkName("clang_disposeIndex")]
	...
	[CLink, LinkName("clang_parseTranslationUnit")]
	public static extern CXTranslationUnit ParseTranslationUnit(CXIndex index, [MangleConst] c_char* path, [MangleConst] c_char** argv, c_int argc, CXUnsavedFile* unsavedFiles, c_uint unsavedFilesCount, CXTranslationUnit_Flags options);

	[CLink, LinkName("clang_disposeTranslationUnit")]
	...
	[CLink, LinkName("clang_getTranslationUnitCursor")]
	...
	[CLink, LinkName("clang_getCursorType")]
	public static extern CXType GetCursorType(CXCursor cursor);

	[CLink, LinkName("clang_getTypeSpelling")]
	public static extern CXString GetTypeSpelling(CXType type);

	[CLink, LinkName("clang_getTypeDeclaration")]
	public static extern CXCursor GetTypeDeclaration(CXType type);

	[CLink, LinkName("clang_getPointeeType")]
	public static extern CXType GetPointeeType(CXType type);

	[CLink, LinkName("clang_getTypedefDeclUnderlyingType")]
	public static extern CXType GetTypedefDeclUnderlyingType(CXCursor type);
